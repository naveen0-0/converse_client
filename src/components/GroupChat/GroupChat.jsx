...
export default function GroupChat() {
  ...
  const { btnText, socket, setAddUserToTheGroupActive,addUserToTheGroupActive,setOperation,operation,setFeedback2,feedback2,setUser,user,setModalActive,modalActive } = useContext(SocketContext)
        ...
        <div className={styles.chat}>
          ...
          <div className={styles.banner}>
            <div className={styles.groupbanner}>
              <div className={styles.back} onClick={RemoveGroup}><img src={backpng} alt="Back Png" className={styles.backpng}/></div>
            ...
            <div className={modalActive? styles.modalactive :  styles.modal}>
              ...
              <input autoFocus={true} type="text" value={friendName} onChange={e => setFriendName(e.target.value)} className={styles.addfriend} placeholder="Enter a friend name" onKeyPress={fetchUserToAddToTheGroup}/>
